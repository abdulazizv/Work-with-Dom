...
pokemon.forEach((items) => {
  let content = `
          <div class="card-img text-center">
            <img src="${items.img}" class="img-fluid" alt="img" width="157px "height="157px">
          </div>
          ...
          <div class="card-body">
            ...
            <div class="card-info">
              <div class="d-flex">
                <h5 class="card-info-kg">${items.weight}</h5>
                <h5 class="card-info-age">${items.height} height</h5>
              </div>
            </div>
          </div>
    `;
  ...
  rowContent.append(createdElement);
});
